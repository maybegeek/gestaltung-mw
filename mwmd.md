...
Erstreckt sich die zitierte Stelle auch über die folgende Seite, so ist dies mit dem Zusatz »f.« zu vermerken. Bei mehreren folgenden Seiten, wird der Zusatz »ff.« verwendet. Beispiel: Emmer (2005, S. 32 ff.).
